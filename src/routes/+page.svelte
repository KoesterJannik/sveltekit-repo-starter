...
<div class="bg-white">
	<header class="absolute inset-x-0 top-0 z-50">
		<nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
			...
			<div class="flex lg:flex-1 lg:justify-end"></div>
		</nav>
	</header>
	...
	<div class="relative isolate px-6 pt-14 lg:px-8">
		...
		<div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
			<div class="hidden sm:mb-8 sm:flex sm:justify-center">
				<div
					class="relative rounded-full px-3 py-1 text-sm leading-6 text-primary ring-1 ring-primary/10 hover:ring-primary/20"
				>
		...
		<div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
			...
			>
				<div class="relative pl-16">
					...
					<dd class="mt-2 text-base leading-7 text-primary">
...
<footer class="bg-white" aria-labelledby="footer-heading">
	...
	<div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
		<div class="xl:grid xl:grid-cols-3 xl:gap-8">
			...
			<div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
				<div class="md:grid md:grid-cols-2 md:gap-8">
					...
					<div class="mt-10 hidden md:mt-0"></div>
				</div>
				<div class="md:grid md:grid-cols-2 md:gap-8">
					<div class="hidden"></div>
					<div class="mt-10 md:mt-0">
						...
						<ul role="list" class="mt-6 space-y-4">
							{#each siteData.footerLinks.legal as link}
								<li>
									<a href={link.href} class="text-sm leading-6 text-primary hover:text-primary"
										>{link.name}</a
									>
								</li>
							{/each}
		...
		<div
			class="mt-16 border-t border-primary/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between"
		>
			<div>
			...
			<form class="mt-6 sm:flex sm:max-w-md lg:mt-0">
				...
				<input
					...
					autocomplete="email"
					required
					class="w-full min-w-0 appearance-none rounded-md border-0 bg-white px-3 py-1.5 text-base text-primary shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:w-56 sm:text-sm sm:leading-6"
					placeholder="Enter your email"
				/>
				<div class="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
					<button
						type="submit"
						class="flex w-full items-center justify-center rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
						>Subscribe</button
					>
				</div>
			</form>
		</div>
		<div class="mt-8 border-t border-primary/10 pt-8 md:flex md:items-center md:justify-between">
			<div class="flex space-x-6 md:order-2"></div>
			<p class="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">
				{siteData.copyRightFooter.text}
			</p>
		</div>
	</div>
</footer>
